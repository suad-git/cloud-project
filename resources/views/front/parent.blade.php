        ...
        <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li><a class="nav-link scrollto" href="#employment"> Search </a></li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 d-flex flex-column justify-content-center">
                    <h1 data-aos="fade-up"> About Our Website </h1>
                    <!--  <h1 data-aos="fade-up" data-aos-delay="400"> نتميز عن غيرنا بسرعة إنجاز المعاملات وسرعة وصول العاملة إليكم -->
                    <ul class="list-unstyled mt-2" data-aos="fade-up" data-aos-delay="150">
                        <li> <i class="bi bi-check "></i> Online Presence 24/7 </li>
                        <li> <i class="bi bi-check "></i>  Information Exchange  </li>
                        <li> <i class="bi bi-check "></i> Credibility </li>
                        <li> <i class="bi bi-check "></i> It Cuts Costs  </li>
                        <li> <i class="bi bi-check "></i> Market Expansion </li>
                        <li> <i class="bi bi-check "></i> Consumer Insights </li>
                        <li> <i class="bi bi-check "></i> Advertising </li>
                        <li> <i class="bi bi-check "></i> Customer Service Online </li>
                    </ul>
                </div>
